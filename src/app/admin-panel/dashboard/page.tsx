...
import { IndianRupee, ShoppingCart, UserPlus, TrendingUp, ExternalLink, RefreshCw } from "lucide-react";
...
export default function DashboardPage() {
  ...
  // Initialize data on mount using Clerk's real token
  useEffect(() => {
    refreshAll(getToken);
  }, []);
    ...
    return (
      <div>
        ...
        <div className="bg-red-50 border border-red-200 rounded-xl p-6 text-center">
          ...
          <Button onClick={() => refreshAll(getToken)} variant="outline">
  ...
  const stats = {
    ...
    avgOrderValue:
      kpis.totalOrders > 0
        ? parseFloat(kpis.totalRevenue) / kpis.totalOrders
        : 0,
    revenueChange: 12.5,
    ordersChange: 8.3,
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <RevenueTrendChart data={revenueTrend} isLoading={isLoading || !data} />
        ...
        <div className="lg:col-span-2 bg-white rounded-xl border border-border">
          <div className="flex items-center justify-between p-5 border-b border-border">
            ...
            <Link
              ...
              className="text-xs text-emerald font-semibold hover:underline flex items-center gap-1"
            >
                    ...
                    >
                      <td className="px-5 py-3">
                        <Link
                          ...
                          className="font-semibold text-charcoal hover:text-emerald"
                        >
                          {order.orderNumber}
                        </Link>
                      </td>
